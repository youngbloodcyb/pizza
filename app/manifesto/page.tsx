export default function Manifesto() {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-lg font-bold pb-2">Manifesto</h1>
        <hr />
      </div>
      <h2 className="text-3xl mb-8">Like the best pizza, we too bleed red</h2>
      <div className="space-y-6 text-lg">
        <p>
          ...
          pizza is created equal. We&apos;re talking about the soul-stirring
          kind, crafted by hands calloused and weathered by years of dedication.
        </p>
        <p>
        ...
        <p>
          They pour their hearts into every pie, nourishing their community one
          slice at a time.
        </p>
