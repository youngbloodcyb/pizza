...
export async function VideoComponent({ fileName }: { fileName: string }) {
  ...
  return (
    <div className="w-96 md:w-[600px] border-2 border-gray-400 shadow-md bg-gray-200">
      <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white p-1 flex justify-between items-center">
        <span className="text-sm font-bold">Propaganda</span>
        <div className="flex space-x-1">
          <button className="w-4 h-4 bg-gray-300 border border-gray-500 text-black text-xs flex items-center justify-center">
            _
          </button>
          <button className="w-4 h-4 bg-gray-300 border border-gray-500 text-black text-xs flex items-center justify-center">
            □
